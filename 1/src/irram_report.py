...
def generate_makefile(casename):
    ...
    opt_bin = "opt"
    double_bin = "double"
    save_makefile([irram_bin] + [opt_bin] +[double_bin], make_file)
...
def analysis(case, mode='all'):
    ...
    analysis_command = "../../../src/analysis_irram --irram=" + irram_result_file + " --opt=" + opt_result_file + "  --double=" + double_result_file + " --mode=" + mode + " > error." + mode
